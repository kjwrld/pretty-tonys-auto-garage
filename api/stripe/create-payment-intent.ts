...
export default async function handler(req: VercelRequest, res: VercelResponse) {
    ...
    try {
        ...
        console.log(`💳 Creating payment intent for $${(amount / 100).toFixed(2)} via Connect account`);
        ...
        console.log(`✅ Created payment intent ${paymentIntent.id} for $${(amount / 100).toFixed(2)}`);
