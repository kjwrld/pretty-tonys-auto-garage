...
import shirtImage from 'figma:asset/184f8b8fd945e5225c9c915577075c097cc4a131.png';
import hatImage from 'figma:asset/7ce726552727d9f5c4aa45166cf08eb9db2cc815.png';
import bannerImage from 'figma:asset/2f04bf86489c8bed8bdae3bfe555bd75f7eba7f1.png';

const PRODUCTS: Product[] = [
  {
    id: '1',
    name: 'Classic Polo Shirt',
    description: 'Premium red polo • Embroidered shop logo',
    longDescription: 'Premium quality polo shirt featuring the iconic Pretty Tony\'s Autoshop embroidered logo. Crafted from high-grade cotton blend for superior comfort and durability. Perfect for shop visits, car meets, or everyday wear. Limited edition design exclusive to our garage.',
    price: 79.99,
    originalPrice: 88.88,
    image: shirtImage,
    additionalImages: [
  ...
  },
  {
    ...
    longDescription: 'Classic snapback hat in vibrant red with custom blue car embroidery. Adjustable fit with premium stitching and structured crown. Perfect for keeping the sun out while wrenching or cruising. Rep Pretty Tony\'s Autoshop in style wherever you go.',
    price: 39.99,
    originalPrice: 44.44,
    image: hatImage,
    additionalImages: [
  ...
  },
  {
    ...
    longDescription: 'Soft premium cotton t-shirt with bold Pretty Tony\'s Autoshop graphics. Designed for comfort and style with reinforced stitching and fade-resistant print. The perfect garage wear for enthusiasts who appreciate quality craftsmanship and automotive culture.',
    price: 49.99,
    originalPrice: 55.55,
  ...
  },
  {
    ...
    longDescription: 'Enter for your chance to win exclusive prizes from Pretty Tony\'s Autoshop. Choose from single tickets or value bundles for better odds. Proceeds support our garage community and upcoming automotive events. Winners announced monthly.',
    price: 10.00,
    originalPrice: 10.00,
    ...
    variants: [
      { id: '1-ticket', name: '1 Ticket', price: 10.00, originalPrice: 10.00 },
      { id: '3-tickets', name: '3 Tickets', price: 25.00, originalPrice: 30.00 },
      { id: '10-tickets', name: '10 Tickets', price: 50.00, originalPrice: 100.00 },
    ],
  },
];
...
export default function App() {
  ...
  const handleAddToCart = (productId: string, quantity: number, variantOrSize?: string) => {
    const cartKey = variantOrSize ? `${productId}-${variantOrSize}` : productId;
    setCart(prev => {
    ...
    if (product) {
      ...
      toast.success(`CART_UPDATE: ${itemName.toUpperCase()} (×${quantity}) ADDED`);
    }
  };
        ...
        <main className="pt-32 pb-12 px-4 relative z-10">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="mb-12 border-2 border-black/20 overflow-hidden reveal-top">
              ...
              <div className="p-8 hidden md:block">
                <div className="flex items-center justify-between mb-4">
                  <div className="text-[10px] text-black/50 uppercase tracking-wider">CATALOG_V2.0</div>
                  <div className="text-[10px] text-red-500">●LIVE</div>
                </div>
                <div className="h-px bg-black/10 mb-4" />
                <h1 className="mb-4 uppercase tracking-wider text-black">Premium Garage Gear</h1>
                <p className="text-black/70 max-w-2xl text-sm leading-relaxed">
                  Exclusive merchandise collection from Pretty Tony's Autoshop. 
                  Quality meets style with our limited edition apparel and accessories.
                </p>
            ...
            <div className="flex items-center gap-3 mb-6">
              <span className="text-[10px] text-black/50 uppercase tracking-wider">AVAILABLE_ITEMS</span>
              <div className="h-px flex-1 bg-black/20" />
              <span className="text-[10px] text-black/30">SORT: FEATURED</span>
            </div>
