        ...
        <div className="relative max-w-7xl mx-auto px-4 py-12">
          ...
          <div className="flex items-center justify-center gap-6 mb-8">
            <a 
              ...
              className="flex items-center justify-center w-12 h-12 border-2 border-white bg-transparent hover:bg-white hover:text-red-500 transition-all duration-300 group"
              aria-label="YouTube"
            >
              <Youtube className="w-6 h-6 text-white group-hover:text-red-500" />
            </a>
            ...
            >
              <Instagram className="w-6 h-6 text-white group-hover:text-red-500" />
            </a>
            ...
            >
              <Music className="w-6 h-6 text-white group-hover:text-red-500" />
            </a>
            ...
            <a 
              ...
              aria-label="Spotify"
            >
              <svg className="w-6 h-6 text-white group-hover:text-red-500" fill="currentColor" viewBox="0 0 24 24">
