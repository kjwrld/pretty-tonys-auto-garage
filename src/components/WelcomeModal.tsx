      ...
      <div className="relative w-full max-w-2xl max-h-[85vh] md:max-h-none overflow-y-auto bg-white border-4 border-black modal-expand">
        ...
        <div className="p-4 md:p-8">
          ...
          <div className="space-y-3 md:space-y-6">
            <div className="border-2 border-red-500 bg-white p-3 md:p-6 relative modal-offer-reveal" style={{ animationDelay: '0.6s' }}>
              ...
              <div className="flex items-center justify-center gap-2 md:gap-3 mb-2 md:mb-4">
                ...
                <span className="text-[10px] text-black/50 uppercase tracking-wider">Special Offer</span>
                <span className="text-red-500 pulse-red">●</span>
                <span className="text-[10px] text-red-500 uppercase tracking-wider font-bold">Active</span>
                <div className="h-px w-8 md:w-12 bg-red-500/30" />
              </div>
              
              <div className="text-center mb-2 md:mb-4">
                <div className="flex flex-col md:flex-row items-center justify-center gap-1 md:gap-4 mb-1 md:mb-2">
                  <span className="text-black/50 uppercase tracking-wider text-[10px] md:text-sm">Standard Pricing</span>
                  <div className="hidden md:block w-8 h-px bg-red-500" />
                  <span className="text-xl md:text-3xl text-red-500 uppercase tracking-tight" style={{ fontWeight: 900 }}>
                    10% OFF
                  </span>
                </div>
              </div>
            ...
            <div className="relative group">
              ...
              >
                ...
                <div className="relative flex items-center justify-center gap-3 md:gap-4">
                  ...
                  <span className="uppercase tracking-[0.2em] md:tracking-[0.3em] text-base md:text-lg" style={{ fontWeight: 900 }}>
                    Enter Shop
                  </span>
                  <div className="h-px w-6 md:w-8 bg-white/30 group-hover:bg-white/60 transition-all" />
                </div>
